...
export default function SpotifyWidget() {
  ...
  const playlist = [
    {
      title: "Nagar Nandaji Na lal",
      artist: "Aditya Gadhvi",
      album: "Nagar Nandaji Na lal",
      cover: "https://source.boomplaymusic.com/group10/M00/12/07/bc47c34edf754292b0295fc60d245fb3_464_464.jpg?height=200&width=200&text=After+Hours",
      duration: "3:20",
      progress: 29,
    },
    {
      ...
      artist: "Aditya Gadhvi",
      album: "Ochhav",
      cover: "https://i.ytimg.com/vi/DZmNMseW9s4/maxresdefault.jpg?height=200&width=200&text=Harry's+House",
      duration: "2:47",
      progress: 0,
    },
    {
      ...
      artist: "Aditya Gadhvi",
      album: "Coke Studio",
      cover: "https://rollingstoneindia.com/wp-content/uploads/2023/11/Khalasi-For-brand-cokestudio-1536x1536-1.jpg?height=200&width=200&text=Starboy",
      duration: "3:50",
      progress: 0,
    },
  ]
